...
const NewsLatterBox = ({ theme }: { theme: "light" | "dark" | "system" }) => {
  return (
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
              <div
                className="mb-12 rounded-xs bg-white px-8 py-11 shadow-three dark:bg-gray-dark sm:p-13.75 lg:mb-5 lg:px-8 xl:p-13.75"
                data-wow-delay=".15s
              "
              >
