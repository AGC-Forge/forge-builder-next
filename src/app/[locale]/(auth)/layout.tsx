...
export default function AuthLayout({
  ...
  return (
    <div className="flex min-h-svh flex-col items-center justify-center gap-6 z-10 overflow-hidden p-6 md:p-10 relative">
      ...
      <div className="flex w-full max-w-125 flex-col gap-6">
        <Link
          href="/"
          locale={locale}
          className="flex items-center gap-0.5 self-center"
        >
          <Image
            src="/logo.png"
            alt="SnapLand Logo"
