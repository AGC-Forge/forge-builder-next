...
export default async function Home() {
  ...
  return (
    <div className="static">
      <div className="pointer-events-none absolute hidden lg:block left-0 top-4 opacity-30 lg:opacity-100 -rotate-90">
        <svg
          width="450"
          height="556"
          viewBox="0 0 450 556"
      ...
      <div className="pointer-events-none absolute hidden lg:block top-100 right-0 opacity-30 lg:opacity-90">
        <svg
          width="364"
          height="201"
          viewBox="0 0 364 201"
